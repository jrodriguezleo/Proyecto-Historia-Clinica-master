...
public class Engine {
    ...
    public void AddPatient(Patient p) {
        ...
        patientsUsernameToId.put(p.getUserName(), p.getId());
    }

    public Patient RemovePatient(Patient p) {
        patients.remove(p.getId());
        patientsUsernameToId.remove(p.getUserName());
        return p;
    }
    ...
    public User login(String userName, String password) {
        ...
        for (Doctor d : doctors) {
            if (Objects.equals(d.getUserName(), userName) && Objects.equals(d.getPassword(), password))
                return d;
        }
        for (Admin a : admins) {
    ...
    public void adUsuario(User usuario, int opcion) {
        ...
        switch (opcion) {
            case 0 -> {
                ...
                Doctor newDoctor = new Doctor(especialidad, eps, id, userName, password, nombre, apellido, nacimiento,
                        genero, direccion, telefono, email);
            ...
            case 1 -> {
                ...
                System.out.println("Ingrese su email");
                String email = scan.nextLine();
                Patient newPatient = new Patient(id, userName, password, nombre, apellido, nacimiento, genero,
                        direccion, telefono, email, eps);
    ...
    public void addPaciente(User usuario, int id) {
        ...
        if (paciente == null) {
            System.out.println("No existe ningún paciente con ese numero de identificación");
            return;
        }
        ((Doctor) usuario).addPatient(paciente);
    }
    ...
    public void addRegistroMedico(User usuario, int id) {
        if (usuario instanceof Doctor) {
            ...
            System.out.println("esto no debia pasar onooooo");
    ...
    public User getUser(User user, int id) {
        ...
        if (user instanceof Doctor) {
            ...
            Patient paciente = (Patient) getUser(user, id);
            if (paciente != null) {
                return paciente;
            }
    ...
    public void removeUser(User user, int id) {
        ...
        if (userRemove instanceof Patient) {
            this.RemovePatient((Patient) userRemove);
            int numDoc = 0;
    ...
    private void initialData() {
        ...
        Patient patient0 = new Patient(0, "p1", "p1", "Juan", "Perez", "1-1-2000", "M", "Calle 123", "300 123 9900",
                "correo@gmail.com", epsHolder);
        Patient patient1 = new Patient(1, "patient1", "password123", "My Name", "My Last Name", "1-1-2000", "M",
                "Calle 123", "300 123 9900", "correo@gmail.com", epsHolder);
        Patient patient2 = new Patient(2, "patient2", "password123", "My Name", "My Last Name", "1-1-2000", "M",
                "Calle 123", "300 123 9900", "correo@gmail.com", epsHolder);
        Patient patient3 = new Patient(3, "patient3", "password123", "My Name", "My Last Name", "1-1-2000", "M",
                "Calle 123", "300 123 9900", "correo@gmail.com", epsHolder);
        Patient patient4 = new Patient(4, "patient4", "password123", "My Name", "My Last Name", "1-1-2000", "M",
                "Calle 123", "300 123 9900", "correo@gmail.com", epsHolder);
        ...
        doctors.add(new Doctor("Internista", epsHolder, 100, "doc0", "password123", "My Name", "My Last Name",
                "1-1-2000", "M", "Calle 123", "300 123 9900", "correo@gmail.com"));
        Doctor doc1 = new Doctor("Pediatra", epsHolder, 101, "doc1", "password123", "My Name", "My Last Name",
                "1-1-2000", "M", "Calle 123", "300 123 9900", "correo@gmail.com");
        doctors.add(doc1);
        ...
        doctors.add(new Doctor("Neurologo", epsHolder, 102, "doc2", "password123", "My Name", "My Last Name",
                "1-1-2000", "M", "Calle 123", "300 123 9900", "correo@gmail.com"));
        ...
        if (this.action.size() != 0) {
            ...
            if (action == 3) {
                ...
                if (persona instanceof Patient) {
                    ...
                    AddPatient(paciente);
                    // this.patients.put(paciente.getId(), paciente);
                    // this.patientsUsernameToId.put(paciente.getUserName(), paciente.getId());
    ...
    public boolean testSearchPatient(Integer i) {
        ...
        if (b == true) {
            System.out.println("El paciente con ID" + i + " se encuentra en el sistema.");
        } else {
            System.out.println("El paciente con ID" + i + " no se encuentra en el sistema.");
        }
        return b;
    }
