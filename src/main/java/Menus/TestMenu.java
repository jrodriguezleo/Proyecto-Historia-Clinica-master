...
public class TestMenu {
    ...
    void test1() {
        ...
        for (int j = 1; j < 7; j++) {
            ...
            System.out
                    .println("Execution time for adding " + n + " items to the list: " + timeElapsed + " nanoseconds");
            ...
            // timeElapsed /= 1000000;
            System.out.println("Execution time for searching last item in a list of " + n + " items: " + timeElapsed
                    + " nanoseconds");
            ...
            // convert to milliseconds
            // timeElapsed /= 1000000;
            System.out.println("Execution time for searching first item in a list of " + n + " items: " + timeElapsed
                    + " nanoseconds");
            ...
            // convert to milliseconds
            // timeElapsed /= 1000000;
            System.out.println("Execution time for searching random item (" + poistion + ") in a list of " + n
                    + " items: " + timeElapsed + " nanoseconds");
            System.out.println("---------------------");
        }
    }

    void test2() {
        // Add 100^i patients to the patients list, for m=10 times and averaged each
        // result, for 1<=i<=nTest
    ...
    void test3() {
        // Add 100^i patients to the doctors tree, for m=10 times and averaged each
        // result, for 1<=i<=nTest
    ...
    void test4() {
        ...
        for (int i = 0; i < nTest; i++) {
            ...
            // Print the result of each iteration
            System.out.println(
                    "Queue n=" + (int) amount + " patients to a doctor schedule tooks " + time + " nanoseconds");
    ...
    void test5() {
        ...
        for (int i = 0; i < nTest; i++) {
            ...
            for (int j = 0; j < timesToAverage; j++) {
                ...
                // create users
                for (int k = 0; k < amount; k++) {
                    this.engine.AddPatient(new Patient(k, "patient" + k, "pass123",
            ...
            // Print the result of each iteration
            System.out.println(
                    "Restoring n=" + (int) amount + " patients that have been removed tooks " + time + " nanoseconds");
    ...
    void test7() {
        ...
        for (int j = 1; j < 6; j++) {
            ...
            System.out
                    .println("Execution time for adding " + n + " items to the tree: " + timeElapsed + " nanoseconds");
            ...
            // timeElapsed /= 1000000;
            System.out.println("Execution time for searching last item in a tree of " + n + " items: " + timeElapsed
                    + " nanoseconds");
            ...
            // convert to milliseconds
            // timeElapsed /= 1000000;
            System.out.println("Execution time for searching first item in a tree of " + n + " items: " + timeElapsed
                    + " nanoseconds");
            ...
            // convert to milliseconds
            // timeElapsed /= 1000000;
            System.out.println("Execution time for searching random ID (" + position + ") in a tree of " + n
                    + " items: " + timeElapsed + " nanoseconds");
            System.out.println("---------------------");
        }
    }
